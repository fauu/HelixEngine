/*******************************************************************************
 * This file is a part of libGDX (https://github.com/libgdx/libgdx/).
 *
 * Copyright 2011 See AUTHORS file (https://github.com/libgdx/libgdx/blob/master/AUTHORS).
 *
 * Licensed under the Apache License, Version 2.0 (the "License");https://github.com/libgdx/libgdx/blob/master/AUTHORS
 ...
 *
 * Modified by Helix Engine Developers:
 *   - added quick and dirty particle translation support
 ******************************************************************************/
...
public class ParticleEmitter {
	...
	public void update (float xTranslation, float yTranslation, float delta) {
		...
		for (int i = 0, n = active.length; i < n; i++) {
			if (active[i] && !updateParticle(particles[i], xTranslation, yTranslation, delta, deltaMillis)) {
				active[i] = false;
				activeCount--;
			}
		}
	...
	private void activateParticle (int index) {
		...
		if (offsetTime > 0) {
			...
			updateParticle(particle, 0, 0, offsetTime / 1000f, offsetTime);
		}
	}

	private boolean updateParticle (Particle particle, float xTranslation, float yTranslation, float delta, int deltaMillis) {
    ...
    particle.translate(xTranslation, yTranslation);
